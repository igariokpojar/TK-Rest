...
public class TaskController {
    ...
    @GetMapping("/{taskId}")
    public ResponseEntity<ResponseWrapper> geTaskById(@PathVariable("taskId")Long taskId){
    ...
    public ResponseEntity<ResponseWrapper> createTask(@RequestBody TaskDTO task){
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseWrapper("Tasks is successfully created",HttpStatus.CREATED));
    }
    ...
    @GetMapping("/employee/pending-tasks") // give me all the tasks assigned to me
